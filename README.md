...
`Cisco Packet Tracer` `Wireshark` `Linux` `Python` `Git & GitHub` `Redes TCP/IP`
...
Formação em **Cibersegurança** e Desenvolvimento Pessoal — 2026.
...
**LinkedIn:** [Nívia Ribeiro Pereira](https://www.linkedin.com/in/niviarpereira/)
